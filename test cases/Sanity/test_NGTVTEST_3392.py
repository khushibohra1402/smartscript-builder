...
pytest.test_NGTVTEST_3392_counter = 0
...
def executeTestCase():
    ...
    # Navigate to unicast encrypted channel
    print("Tuning to a unicast encrypted channel")
...
def test_NGTVTEST_3392(extra):
    pytest.test_NGTVTEST_3392_counter += 1
    testoutputname = __name__ + "_" + str(pytest.test_NGTVTEST_3392_counter)
    try:
