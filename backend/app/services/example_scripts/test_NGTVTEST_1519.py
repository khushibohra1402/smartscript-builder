...
Test Case ID: NGTVTEST-1519

Test Case Description: No schedule recordings are displayed

Expected result: No scheduled recordings should be present in recordings menu as expected
