...
Test Case ID: NGTVTEST-1518

Test Case Description: Lack of recordings or the recordings are not available

Expected result: No recordings should be present in recordings menu as expected
...
def executeTestCase():
    ...
    while not screen.isAllRecordingsDeleted():
        ...
        if iteration == 0:
            break
    print("No recordings available in the Meine Aufnahme screen. (Text displayed: Individuell planen, EPG, Suche)")
